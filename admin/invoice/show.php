	...
	<div class="card-body">
		<div class="container-fluid">
			<form action="" id="invoice-form">
				<input  value="<?php echo isset($id) ? $id : '' ?>">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="invoice_code" class="control-label">Invoice Code</label>
							<input value="<?php echo isset($invoice_code) ? $invoice_code : ''; ?>"  class="form-control form-control-sm" required>
						</div>
						<div class="form-group">
							<label for="customer_name" class="control-label">Customer Name</label>
							<textarea  cols="30" rows="2" class="form-control form no-resize"><?php echo isset($customer_name) ? $customer_name : ''; ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<option <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>Product</option>
							<option <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Services</option>
							</select>
						</div>
					</div>
				</div>
